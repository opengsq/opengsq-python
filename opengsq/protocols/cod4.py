...
class CoD4(ProtocolBase):
    """
    This class represents the Call of Duty 4 Protocol. It provides methods to interact with CoD4 servers.
    """
    ...
    def __init__(self, host: str, port: int = 28960, timeout: float = 5.0):
        """
        Initializes the CoD4 object with the given parameters.
        ...
        self._source_port = 28960  # CoD4 requires source port 28960
    ...
    async def get_full_status(self, challenge: str = "xxx") -> Cod4Status:
        """
        Asynchronously retrieves both server info and status.

        :param challenge: The challenge string to send (default: "xxx").
        :return: A Cod4Status object containing both info and status.
        """
        import asyncio
        ...
        return Cod4Status(info=info, status=status)
